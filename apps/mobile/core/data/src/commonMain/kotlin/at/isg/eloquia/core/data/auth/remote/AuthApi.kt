...
internal class AuthApi(
    ...
    suspend fun redeemPairingCode(request: ServerPairingCodeRedeemRequest): ApiResult<ServerLinkResponse> =
        networkClient.post(path = "/links/pairing-code/redeem", body = request)
