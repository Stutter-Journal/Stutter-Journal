...
import at.isg.eloquia.core.data.auth.dto.RevokeLinksResponseDto
...
internal class AuthApi(
    ...
    suspend fun redeemPairingCode(request: ServerPairingCodeRedeemRequest): ApiResult<ServerLinkResponse> = networkClient.post(path = "/links/pairing-code/redeem", body = request)
    ...
    suspend fun revokeLinks(): ApiResult<RevokeLinksResponseDto> = networkClient.post(path = "/links/revoke")
}
