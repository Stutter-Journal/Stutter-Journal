...
func (_u *CommentUpdate) SetEntryID(v uuid.UUID) *CommentUpdate {
	_u.mutation.SetEntryID(v)
	return _u
}

// SetNillableEntryID sets the "entry_id" field if the given value is not nil.
func (_u *CommentUpdate) SetNillableEntryID(v *uuid.UUID) *CommentUpdate {
	if v != nil {
		_u.SetEntryID(*v)
	}
	return _u
...
func (_u *CommentUpdate) SetAuthorDoctorID(v uuid.UUID) *CommentUpdate {
	_u.mutation.SetAuthorDoctorID(v)
	return _u
}

// SetNillableAuthorDoctorID sets the "author_doctor_id" field if the given value is not nil.
func (_u *CommentUpdate) SetNillableAuthorDoctorID(v *uuid.UUID) *CommentUpdate {
	if v != nil {
		_u.SetAuthorDoctorID(*v)
	}
	return _u
}
...
func (_u *CommentUpdate) SetEntry(v *Entry) *CommentUpdate {
	return _u.SetEntryID(v.ID)
}

// SetAuthorID sets the "author" edge to the Doctor entity by ID.
func (_u *CommentUpdate) SetAuthorID(id uuid.UUID) *CommentUpdate {
	_u.mutation.SetAuthorID(id)
	return _u
}

// SetAuthor sets the "author" edge to the Doctor entity.
func (_u *CommentUpdate) SetAuthor(v *Doctor) *CommentUpdate {
...
func (_u *CommentUpdate) ClearEntry() *CommentUpdate {
...
func (_u *CommentUpdate) check() error {
	...
	if _u.mutation.EntryCleared() && len(_u.mutation.EntryIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Comment.entry"`)
	}
...
func (_u *CommentUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.EntryCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   comment.EntryTable,
			Columns: []string{comment.EntryColumn},
			Bidi:    false,
...
// SetEntryID sets the "entry_id" field.
func (_u *CommentUpdateOne) SetEntryID(v uuid.UUID) *CommentUpdateOne {
	_u.mutation.SetEntryID(v)
	return _u
}

// SetNillableEntryID sets the "entry_id" field if the given value is not nil.
func (_u *CommentUpdateOne) SetNillableEntryID(v *uuid.UUID) *CommentUpdateOne {
	if v != nil {
		_u.SetEntryID(*v)
	}
	return _u
...
// SetAuthorDoctorID sets the "author_doctor_id" field.
func (_u *CommentUpdateOne) SetAuthorDoctorID(v uuid.UUID) *CommentUpdateOne {
	_u.mutation.SetAuthorDoctorID(v)
	return _u
}

// SetNillableAuthorDoctorID sets the "author_doctor_id" field if the given value is not nil.
func (_u *CommentUpdateOne) SetNillableAuthorDoctorID(v *uuid.UUID) *CommentUpdateOne {
	if v != nil {
		_u.SetAuthorDoctorID(*v)
	}
	return _u
...
// SetEntry sets the "entry" edge to the Entry entity.
func (_u *CommentUpdateOne) SetEntry(v *Entry) *CommentUpdateOne {
	return _u.SetEntryID(v.ID)
}

// SetAuthorID sets the "author" edge to the Doctor entity by ID.
func (_u *CommentUpdateOne) SetAuthorID(id uuid.UUID) *CommentUpdateOne {
	_u.mutation.SetAuthorID(id)
	return _u
}

// SetAuthor sets the "author" edge to the Doctor entity.
func (_u *CommentUpdateOne) SetAuthor(v *Doctor) *CommentUpdateOne {
	return _u.SetAuthorID(v.ID)
}
...
// ClearEntry clears the "entry" edge to the Entry entity.
func (_u *CommentUpdateOne) ClearEntry() *CommentUpdateOne {
	_u.mutation.ClearEntry()
	return _u
}
