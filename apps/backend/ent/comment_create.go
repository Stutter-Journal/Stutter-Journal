...
func (_c *CommentCreate) SetEntryID(v uuid.UUID) *CommentCreate {
	_c.mutation.SetEntryID(v)
	return _c
}

// SetAuthorDoctorID sets the "author_doctor_id" field.
func (_c *CommentCreate) SetAuthorDoctorID(v uuid.UUID) *CommentCreate {
	_c.mutation.SetAuthorDoctorID(v)
	return _c
}
...
func (_c *CommentCreate) SetEntry(v *Entry) *CommentCreate {
	return _c.SetEntryID(v.ID)
}

// SetAuthorID sets the "author" edge to the Doctor entity by ID.
func (_c *CommentCreate) SetAuthorID(id uuid.UUID) *CommentCreate {
	_c.mutation.SetAuthorID(id)
	return _c
}

// SetAuthor sets the "author" edge to the Doctor entity.
func (_c *CommentCreate) SetAuthor(v *Doctor) *CommentCreate {
...
func (_c *CommentCreate) check() error {
	if _, ok := _c.mutation.EntryID(); !ok {
		return &ValidationError{Name: "entry_id", err: errors.New(`ent: missing required field "Comment.entry_id"`)}
	}
	if _, ok := _c.mutation.AuthorDoctorID(); !ok {
		return &ValidationError{Name: "author_doctor_id", err: errors.New(`ent: missing required field "Comment.author_doctor_id"`)}
	}
	...
	if len(_c.mutation.EntryIDs()) == 0 {
		return &ValidationError{Name: "entry", err: errors.New(`ent: missing required edge "Comment.entry"`)}
	}
