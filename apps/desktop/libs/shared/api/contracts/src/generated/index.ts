...
export interface ServerMyDoctorPracticeResponse {
  address?: string;
  name?: string;
}

export interface ServerMyDoctorResponse {
  displayName?: string;
  email?: string;
  myDoctorPractice?: ServerMyDoctorPracticeResponse;
}
...
export interface ServerRevokeLinksResponse {
  revoked?: number;
}
 ...
 */
export type postLinksRevokeResponse200 = {
  data: ServerRevokeLinksResponse;
  status: 200;
};

export type postLinksRevokeResponse401 = {
  data: ServerErrorResponse;
  status: 401;
};

export type postLinksRevokeResponse500 = {
  data: ServerErrorResponse;
  status: 500;
};

export type postLinksRevokeResponseSuccess = postLinksRevokeResponse200 & {
  headers: Headers;
};
export type postLinksRevokeResponseError = (
  | postLinksRevokeResponse401
  | postLinksRevokeResponse500
) & {
  headers: Headers;
};

export type postLinksRevokeResponse =
  | postLinksRevokeResponseSuccess
  | postLinksRevokeResponseError;

export const getPostLinksRevokeUrl = () => {
  return `http://localhost:8080/links/revoke`;
};

export const postLinksRevoke = async (
  options?: RequestInit,
): Promise<postLinksRevokeResponse> => {
  const res = await fetch(getPostLinksRevokeUrl(), {
    ...options,
    method: 'POST',
  });
  ...
  const data: postLinksRevokeResponse['data'] = body ? JSON.parse(body) : {};
  return {
    data,
    status: res.status,
    headers: res.headers,
  } as postLinksRevokeResponse;
};
 ...
 */
export type getPatientMydoctorResponse200 = {
  data: ServerMyDoctorResponse;
  status: 200;
};

export type getPatientMydoctorResponse401 = {
  data: ServerErrorResponse;
  status: 401;
};

export type getPatientMydoctorResponse404 = {
  data: ServerErrorResponse;
  status: 404;
};

export type getPatientMydoctorResponseSuccess =
  getPatientMydoctorResponse200 & {
    headers: Headers;
  };
export type getPatientMydoctorResponseError = (
  | getPatientMydoctorResponse401
  | getPatientMydoctorResponse404
) & {
  headers: Headers;
};

export type getPatientMydoctorResponse =
  | getPatientMydoctorResponseSuccess
  | getPatientMydoctorResponseError;

export const getGetPatientMydoctorUrl = () => {
  return `http://localhost:8080/patient/mydoctor`;
};

export const getPatientMydoctor = async (
  options?: RequestInit,
): Promise<getPatientMydoctorResponse> => {
  const res = await fetch(getGetPatientMydoctorUrl(), {
    ...options,
    method: 'GET',
  });
  ...
  const data: getPatientMydoctorResponse['data'] = body ? JSON.parse(body) : {};
  return {
    data,
    status: res.status,
    headers: res.headers,
  } as getPatientMydoctorResponse;
};
